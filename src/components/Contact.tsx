...
export function Contact() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set([titleRef.current, formContainerRef.current, ctaRef.current], { opacity: 1 })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Failed to send message. Please try again or email us directly at info@ayyappanco.com')
    } finally {
      ...
      <div className="relative z-10 px-4 mx-auto max-w-[1440px] sm:px-6 lg:px-8">
        <div ref={titleRef} className="mb-8 text-center sm:mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#03045e] mb-3 sm:mb-4">
            Get in Touch <span className='text-[#03045e]'>with Us</span>
          </h2>
            ...
            <Card className="p-6 border-0 shadow-xl bg-white/70">
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="w-full bg-[#03045e] hover:bg-[#03045e]/90 text-white shadow-lg shadow-[#03045e]/30"
          ...
          <Card className="p-5 lg:p-6 bg-[#03045e] border-none shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <span className="px-3 py-1.5 text-xs font-semibold text-white bg-white/20 rounded-full shadow border border-white/20">Free Project Consultation</span>
                <span className="px-3 py-1.5 text-xs font-semibold text-white bg-white/20 rounded-full shadow border border-white/20">TNEB Class I Certified</span>
                <span className="px-3 py-1.5 text-xs font-semibold text-white bg-white/20 rounded-full shadow border border-white/20">Turnkey Solutions</span>
                <span className="px-3 py-1.5 text-xs font-semibold text-white bg-white/20 rounded-full shadow border border-white/20">30 Years Experience</span>
              </div>
            </div>
          </Card>
        </div>
